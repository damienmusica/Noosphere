...
| `social-sciences-skeleton-v1` | Fifth continent (parallel round v1, session #13a, merge order 1), 2026-06-11: 44 generated (9 fields + 35 subfields, 13 ambiguous-flagged, 26 deliberate non-coverage candidates recorded) — QC, resolver-v4 grounding and promotion records follow in this directory. |
| `arts-design-skeleton-v1` | Eighth continent (parallel round 13d, merge order 4), 2026-06-11 (PR #75 manifest): 26 generated → QC kept 25 (fashion-design absorbed into decorative-arts, polymer-chemistry precedent; music-composition absorbed at generator stage), laundering 0/85 (first zero batch), B-flag contest queue 2 (photography TR-vs-UDC77 head-on; urban-planning multi-home); architecture §13 engineering-side dossier live-captured for the edge batch; resolver v4 + promotion pending. |
