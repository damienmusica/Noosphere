# editorial-batch6-indexable-v1 — promotion decision report

**Decided 2026-07-03** · QC by Claude Fable 5 (`claude-fable-5`) · generated from `foundry/decisions/editorial-batch6-indexable-v1.json` by `npm run foundry:report`.
...
|---|---|---|---|
| `concept:tripartite-classification-of-authority` | node reviewed→reviewed | reviewed | — |
